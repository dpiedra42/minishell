...
#    Updated: 2021/04/07 14:24:09 by dpiedra          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS	= main.c parser/parsing.c parser/parsing_utils.c builtins/ft_signal.c \
		  ...
		  builtins/ft_pwd.c builtins/ft_env.c builtins/ft_cd.c parser/split_utils.c \
		  ...
		  parser/parsing_redir2.c builtins/ft_exit.c builtins/ft_export.c \
		  builtins/export_utils.c parser/parsing_redir3.c 
